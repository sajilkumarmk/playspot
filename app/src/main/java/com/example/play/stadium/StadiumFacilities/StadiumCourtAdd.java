...
public class StadiumCourtAdd extends AppCompatActivity {

    EditText gametype, courttype, courtlength,courtwidth, courtamount;
    AppCompatButton add;
    String id, gtype, ctype, clength, cwidth, camount, status, message, url = Config.baseurl+"stadium_add_court.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.s_court_add);

        gametype = findViewById(R.id.sAddGameType);
        courttype = findViewById(R.id.sAddCourtType);
        courtlength = findViewById(R.id.sAddCourtLength);
        courtwidth = findViewById(R.id.sAddCourtWidth);
        courtamount = findViewById(R.id.sAddCourtAmount);
        add = findViewById(R.id.sCourtAdd);
